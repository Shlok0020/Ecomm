// src/pages/Interiors/Interiors.jsx - WITHOUT "Our Portfolio" AND "Shreyyanshi Glass"
...
const Interiors = () => {
  ...
  const handleImageError = (e) => {
    e.target.src = 'https://via.placeholder.com/800x600/1a1a1a/c9a96e?text=Interior+Project';
  };
    ...
    <div className="int-page">
      ...
      <style>{`
        ...
        *, *::before, *::after {
        ...
        /* 🔥 REMOVED "Our Portfolio" section completely */
        .filters-section {
          display: none;
        }
                ...
                project && (
                  ...
                  >
                    <div className="item-image">
                      <img 
                        src={project.image || 'https://via.placeholder.com/800x600/1a1a1a/c9a96e?text=Interior+Project'} 
